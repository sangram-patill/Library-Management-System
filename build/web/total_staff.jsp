<%-- 
    Document   : total_staff
    Created on : 11 Apr, 2023, 9:36:42 AM
    Author     : sangr
--%>
...
<html>
    <head>
        ...
        <title>YCM Admin - Total Staff</title> 
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">                                
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Total Staff</h4>
                                    </div>
                                    <div class="col-sm-6">
                                         <a href="staff.jsp"><button class="stock">New Staff</button></a>
                                    </div>
                                 </div>
		...
		<tbody>
            ...
            try {
                ...
                while (rs.next()) 
                {
                    ...
                    <input type="hidden" name="staff_name" value="<%=rs.getString("staff_name")%>">
                    ...
                    <input type="hidden" name="taluka" value="<%=rs.getString("taluka")%>">
                    <input type="hidden" name="address" value="<%=rs.getString("address")%>">
                    <input type="hidden" name="state" value="<%=rs.getString("state")%>">
                    <input type="hidden" name="district" value="<%=rs.getString("district")%>">
