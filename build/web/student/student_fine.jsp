...
<html>
    <head>
        ...
        <title>YCM Student -  Student Fine</title> 
    ...
    <body>        
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Fine</h4>
                                    </div>
                                </div>
        ...
        <% 
            try {
                 ...
                 String sql = "select * from student_fine where student_id = '"+session.getAttribute("username")+"'"; ResultSet rs = st.executeQuery(sql);
