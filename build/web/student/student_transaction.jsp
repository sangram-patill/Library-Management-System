<%-- 
    Document   : student_transaction
    Created on : 16 May, 2023, 11:38:09 AM
    Author     : sangr
--%>
...
<html>
    <head>
        ...
        <title>YCM Student - Transaction</title> 
    ...
    <body>    
        ...
        <div class="container">
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">My Transaction</h4>
                                    </div>
                                </div>
                                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%">
                                <marquee>Within 15 days you have to return the book after that you have to pay 2 rs charge per day</marquee>
                                <br>
                                <div class="row">
			...
			<tr>
                            ...
                            <th class="textcenter">Book Accessing ID</th>
        ...
        <% 
            try {
                 ...
                 String sql = "select * from student_issue where student_id = '"+session.getAttribute("username")+"' "; ResultSet rs = st.executeQuery(sql);
                ...
                while (rs.next()) 
                {
                    %>
                        <tr>
                            ...
                            <td style="color: red;"><%=rs.getString("return_date")%></td>
                        </tr>
                    <%
                }
            } 
