...
<html>
    <head>
        ...
        <title>YCM Admin - Dashboard</title> 
            ...
            <div class="content">                   
                  <div class="cards">
                        <div class="card">
                            <div class="box">                                
                                          <br>
                                <h4 style="margin: 0% 0% 0% 2%">Welcome, Yashwantrao Chavan Mahavidyalaya</h4>
                                ...
                                %>         
                                 ...
                                 <%
                                 %>
                                       <p style="text-align: center;color: red;font-weight: bold;">Issued Books</p>
                                    </div>
                                ...
                                %>         
                                 ...
                                 <%
                                 %>
                                <p style="text-align: center;color: green;">Available Books</p>
                                    </div>
                                      <div class="col-sm-3 third">
                                <%
                                  count = 0;
