<%-- 
    Document   : magazine_report
    Created on : 16 May, 2023, 1:06:20 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Principal - Magazine Report </title> 
    ...
    <!---Start Editing from Below Code--->
        ...
        <div class="container">
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="magazine_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Magazine Reports</h4>
                                    </div>           
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Magazine">
                                    </div>
                                 </div>
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Magazine No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="m_id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Magazine"></div>
                  ...
                  <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To ID No.</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="m_acc1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="m_acc2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Magazine By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To Date</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="m_date1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="m_date2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Magazine By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Magazine</h4><br>
		...
		<tbody>
            ...
            try {
                 ...
                 String sql = "select * from magzine where status = 'Returned'"; ResultSet rs = st.executeQuery(sql);
