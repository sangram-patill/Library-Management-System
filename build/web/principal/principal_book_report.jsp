<%-- 
    Document   : principal_book_report
    Created on : 20 Jun, 2023, 2:48:11 PM
    Author     : sangr
--%>
...
<html>
    <head>
        ...
        <title>YCM Principal - Book Report </title> 
         ...
         <!---Start Editing from Below Code--->
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="book_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Book Reports</h4>
                                    </div>     
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Books">
                                    </div>
                                 </div>
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Book Accessing No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Book"></div>
                  ...
                  <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To ID No.</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="b_acc1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="b_acc2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Book By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To Date</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="b_date1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="b_date2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Book By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Books</h4><br>
                        <table style="margin-bottom: 3%;">
		<thead>
			<tr>
                            <th class="textcenter">Entry Date</th>
        ...
        <% 
            try {
                ...
                while (rs.next()) 
                {
                    %>
                        <tr>
                            <td><%=rs.getString("b_date_of_entry")%></td>
