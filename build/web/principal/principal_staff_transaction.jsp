<%-- 
    Document   : principal_staff_transaction
    Created on : 16 May, 2023, 12:02:31 PM
    Author     : sangr
--%>
...
<html>
    <head>
        ...
        <title>YCM Principal - Staff Issue Book </title> 
                        ...
                        <div class="card">
                            <div class="box">  
                               <br>
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Staff Transaction</h4>
                                    </div>
                                </div>
