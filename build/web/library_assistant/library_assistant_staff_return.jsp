...
<html>
    <head>
        ...
        <title>YCM Assistant - Staff Return Book </title> 
            ...
            <div class="content">                   
                  <div class="cards">
                        <div class="card">
                            <div class="box">  
                                <br>
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Staff Return Book</h4>
                                    </div>   
                                     <div class="col-sm-6">
                                        <form action="library_assistant_staff_return.jsp" method="post">
                       ...
                       <%
                            ...
                            String sql = "select * from staff_issue where rid = '"+request.getParameter("txt_sid")+"'"; 
                            ResultSet rs = st.executeQuery(sql);
                            while(rs.next())
                            {
                                t_id = rs.getString("rid");
                                bid=rs.getString("book_accessing_no");
                                sid=rs.getString("staff_id");
                ...
                <form name="library_assistant_staff_return" action="../assistant_staff_return" method="post">
                <!--First and Second Row-->
                <div class="row">
                   <div class="col-sm-4"><label for="return-date" class="x">Transaction ID</label></div> 
                </div>
                    <div class="row">
                        <div class="col-sm-4" ><input class="y" type="text" onkeypress="return isNumber(event)" name="t_id" value="<%=t_id%>"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4"><input class="y" type="text1" value="<%=sid%>" onkeypress="return isNumber(event)" id="borrower-name" name="staff_id" required></div>
...
<!--                    <video id="preview"></video><br>-->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4" ><input class="y" type="text" name="total_days" onkeypress="return isNumber(event)" id="days"></div>                  
                    <div class="col-sm-4"><input class="y" type="text" name="fine" onkeypress="return isNumber(event)" value="0" id="amount"></div>                   
                </div><br><br>
<!--                    <video id="preview1"></video><br>-->
            ...
            <!--Searching Method-->
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%">
                <h4 style="margin: 0% 0% 0% 2%">Staff Return Book List</h4>
                <br>
                <div class="row">
