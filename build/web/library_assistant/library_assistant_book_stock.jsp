<%-- 
    Document   : library_assistant_book_stock
...
<html>
    <head>
        ...
        <title>YCM Assistant - Book Inventory</title> 
    ...
    <body>        
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Total Books</h4>
                                    </div>
                                 </div>
        ...
        <% 
            try {
                 ...
                 String sql = "select * from add_book"; ResultSet rs = st.executeQuery(sql);
