<%-- 
    Document   : secretary_student_issue
    Created on : 16 May, 2023, 3:19:14 PM
    Author     : sangr
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Student Issue Transaction</title> 
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Student Issue Transaction</h4>
                                    </div>
                                </div>
