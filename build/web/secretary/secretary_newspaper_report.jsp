<%-- 
    Document   : newspaper_report
    Created on : 16 May, 2023, 1:08:55 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Newspaper Report </title> 
        ...
        <div class="container">
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="secretary_newspaper_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Newspaper Reports</h4>
                                    </div>       
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Newspaper">
                                    </div>
                                 </div>
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Newspaper No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="n_id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Newspaper"></div>
                  ...
                  <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To ID No.</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="n_acc1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="n_acc2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Newspaper By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">

                 <h4 style="margin: 0% 0% 0% 2%">All Newspaper</h4><br>
