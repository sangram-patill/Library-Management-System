<%-- 
    Document   : student_issue_report
    Created on : 16 May, 2023, 4:12:42 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Student Issue Report </title> 
     ...
     <!---Start Editing from Below Code--->   
        <div class="container">
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="secretary_student_issue_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Student Issue Reports</h4>
                                    </div>              
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Student Issue">
                                    </div>
                                 </div>
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Transaction ID</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="student_issue_id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Issued Student"></div>
                  ...
                  <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To ID No.</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="i_student_acc1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="i_student_acc2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Issued Student By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                   ...
                   <input class="in" type="submit" name="submit" value="View Issued Student By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Issue</h4><br>
		...
		<thead>
            ...
            try {
                 ...
                 String sql = "select * from student_issue"; ResultSet rs = st.executeQuery(sql);
