<%-- 
    Document   : staff_return_report
    Created on : 16 May, 2023, 4:13:35 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Staff Return Report </title> 
        ...
        <div class="container">
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="secretary_staff_return_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Staff Return Reports</h4>
                                    </div>              
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Staff Issue">
                                    </div>
                                 </div>
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Staff  Return No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="staff_return_id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Staff Return"></div>
                  ...
                  <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To ID No.</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="r_staff_acc1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="r_staff_acc2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Staff Return By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To Date</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="staff_r_date1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="staff_r_date2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Staff Return By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Staff  Return</h4><br>
		 ...
		 <thead>
            ...
            try {
                Connection cn = null; Statement st = null;
                 ...
                 String sql = "select * from staff_return"; ResultSet rs = st.executeQuery(sql);
