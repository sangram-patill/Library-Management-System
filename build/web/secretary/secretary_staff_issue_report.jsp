<%-- 
    Document   : staff_issue_report
    Created on : 16 May, 2023, 4:13:17 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Staff Issue Report</title> 
        ...
        <div class="container">
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="secretary_staff_issue_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Staff Issue Report</h4>
                                    </div>              
                                     <div class="col-sm-6">
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Staff Issue No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="staff_issue_id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Staff Issue"></div>
                ...
                <div class="row">
                   ...
                   <input class="in" type="submit" name="submit" value="View Staff Issue By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To Date</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="staff_i_date1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="staff_i_date2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Staff Issue By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Staff Issue</h4><br>
