...
<head> 
        ...
        <title>YCM Staff - Dashboard Page</title> 
...
<body>
            ...
            <ul>                
                ...
                <li class="dropdown">                    
                        ...
                        <ul class="modify-show">
                            <li class="dropdown_two"><a href="staff_available_book_stock.jsp"class="stock-modify-btn"> ● Available Books</a></li>
                            <li class="dropdown_two"><a href="staff_book_stock.jsp"class="stock-modify-btn"> ● Total Books</a></li>                                   
                            <li class="dropdown_two"><a href="staff_journal_stock.jsp"class="general-modify-btn"> ● Journal</a></li>
                            <li class="dropdown_two"><a href="staff_magazine_stock.jsp"class="general-modify-btn"> ● Magazine</a></li>
                            <li class="dropdown_two"><a href="staff_newspaper_stock.jsp"class="general-modify-btn"> ● Newspaper</a></li>
                        </ul>                    
                </li>                                        
                
                <!--five-->                
                      <li class="dropdown">
                        <a href="staff_fine.jsp">
            ...
            <form name="staff_dashboard" action="../staff_id" method="post">
                    <li class="dropdown">
                        <a href="#">
                            <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
                            <lord-icon
     ...
     <div class="container">
        <div class="header">
            <div class="nav">
                ...
                <div class="user">
                    <div class="img-case">
                        <img src="../image/Staff/<%=session.getAttribute("image")%>" alt="NO Image found...">
                    </div>
                </div>
            </div>
        </div>       
