...
<html>
    <head>
        ...
        <title>YCM Admin - Student Registration</title> 
         ...
         <div class="container"> 
            <div class="content">                   
                  <div class="cards">
                        <div class="card">
                            <div class="box">                                
                                      ...
                                      <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Student Register</h4>
                                    </div>
                                    <div class="col-sm-6">
                                         <a href="total_student.jsp"><button class="stock">Total Student</button></a>
                                    </div>
                                 </div>
                  <form action="student" name="student" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4"><label class="x">Year/Stream</label></div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <%
                            ...
                            {
                            %>
                                    <input type="text" id="reg_no" onchange="generatePassword()" name="registration_no" class="y" onkeypress="return isNumber(event)" >
                            <%
                            }
                        %>
                    </div>
                   <div class="col-sm-4">
                       <select name="department" class="y">
                        <%
                                if(request.getParameter("stud_department")!=null)
                                {
                                %>
                                <option value="<%=request.getParameter("stud_department")%>"><%=request.getParameter("stud_department")%></option>
                                <%
                                }
                                else
                                {
                    ...
                    <div class="col-sm-4">
                        ...
                        <%
                                if(request.getParameter("stud_year")!=null)
                                {
                                %>
                                <option value="<%=request.getParameter("stud_year")%>"><%=request.getParameter("stud_year")%></option>
                                <%
                                }
                                else
                                       {
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <%
                            if(request.getParameter("stud_name")!=null)
                            {
                            %>
                                <input type="text" id="name" name="fullname" onkeypress="return isString(event)" onchange="generatePassword()" class="y" value="<%=request.getParameter("stud_name")%>">
                            <%
                            }
                            else
                                   {
                            %>
                                <input type="text" id="name" name="fullname" onkeypress="return isString(event)" onchange="generatePassword()" class="y">
                            <%
                            }
                        %>
                </div>
                   <div class="col-sm-4">
                       <%
                            if(request.getParameter("stud_dob")!=null)
                            {
                            %>
                                    <input type="date" name="fullname" class="y" value="<%=request.getParameter("stud_dob")%>">
                            <%
                            }
                            else
                                   {
                            %>
                            <input type="date" id="name" name="stud_dob" class="y">
                   ...
                   <div class="col-sm-4">
                       <%
                            if(request.getParameter("stud_mobno")!=null)
                            {
                            %>
                            <input type="text" name="mobileno" class="y" maxlength="10" onkeypress="return isNumber(event)" value="<%=request.getParameter("stud_mobno")%>">
                            <%
                            }
                            else
                                   {
                 ...
                 <div class="row">
                   ...
                   <div class="col-sm-4"><label class="x">City/Village</label></div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <%
                            if(request.getParameter("stud_email")!=null)
                            {
                            %>
                            <input type="email" name="email" class="y" value="<%=request.getParameter("stud_email")%>">
                            <%
                            }
                            else
                                   {
                    ...
                    <div class="col-sm-4">
                        <%
                            if(request.getParameter("stud_address")!=null)
                            {
                            %>
                            <input type="text" name="address" class="y" value="<%=request.getParameter("stud_address")%>">
                            <%
                            }
                            else
                            {
                    ...
                    <div class="col-sm-4">
                        <%
                            if(request.getParameter("stud_city")!=null)
                            {
                            %>
                            <input type="text" name="city" class="y" value="<%=request.getParameter("stud_city")%>">
                            <%
                            }
                            else
                            {
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <%
                            if(request.getParameter("stud_pincode")!=null)
                            {
                            %>
                            <input type="text" name="pincode" class="y" maxlength="6" onkeypress="return isNumber(event)" value="<%=request.getParameter("stud_pincode")%>">
                            <%
                            }
                            else
                            {
                            %>
                            <input type="text" name="pincode" maxlength="6" onkeypress="return isNumber(event)" class="y">
                            <%
                            }
                        %>
                    </div>
                    <div class="col-sm-4">
                        ...
                        <%
                                if(request.getParameter("stud_state")!=null)
                                {
                                %>
                                <option value="<%=request.getParameter("stud_state")%>"><%=request.getParameter("stud_state")%></option>
                                <%
                                }
                                else
                                       {
                    ...
                    <div class="col-sm-4">
                        ...
                        <%
                                if(request.getParameter("stud_district")!=null)
                                {
                                %>
                                <option value="<%=request.getParameter("stud_district")%>"><%=request.getParameter("stud_district")%></option>
                                <%
                                }
                                else
                                       {
            ...
            <!--Hidden field to set a role of student -->
                <div class="col-sm-4"><input type="hidden" value="student" name="role"></div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <%
                            if(request.getParameter("stud_taluka")!=null)
                            {
                            %>
                            <input type="text" name="taluka" class="y" onkeypress="return isString(event)" value="<%=request.getParameter("stud_taluka")%>">
                            <%
                            }
                            else
                            {
                     ...
                     <div class="col-sm-4">
                        <%
                            if(request.getParameter("stud_gender")!=null)
                            {
                            %>
                            <input style="margin-left: 50px;" type="radio" value="<%=request.getParameter("stud_gender")%>" name="gender"><label for="Male">Male</label>
                            <input style="margin-left: 20px;" type="radio" value="<%=request.getParameter("stud_gender")%>" name="gender"><label for="Female">Female</label>
                            <input style="margin-left: 20px;" type="radio" value="<%=request.getParameter("stud_gender")%>" name="gender"><label for="Other">Other</label>   
                            <%
                            }
                            else
                            {
                    ...
                    <div class="col-sm-4">
                        <input type="file" name="image" style="margin-left: 50px;">
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <input type="file" name="stud_sign" style="margin-left: 50px;">
                    </div>
                    <div class="col-sm-4">
                        <input type="password" disabled id="password" name="password" class="y" style="margin-left: 50px;">
                    </div>
                    <div class="col-sm-4"><input type="hidden" id="password1" name="password1"></div>
                </div><br><br>
