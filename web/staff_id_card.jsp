...
<html>
<head>
    <title>YCM Admin - Staff ID Card</title>
                    ...
                    <div class="box">
                        ...
                        <%
                            try {
                                ...
                                String sql = "select * from staff where registration_no = '"+session.getAttribute("registration_no")+"'";
                        ...
                        <div class="card1" id="card">
                            ...
                            <img class="idp" src="image/Staff/<%=rs.getString("staff_photo")%>" width="85" height="105">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="photo1">
