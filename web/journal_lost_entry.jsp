...
<html>
    <head>
        ...
        <title>YCM Admin - Lost/Disposal Journal </title> 
       ...
       <%
        ...
        <div class="container">
            <div class="content">                   
                        ...
                        <div class="card">
                            <div class="box">  
                                <br>
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Lost/Disposal Journal Entry</h4>
                                    </div>   
                                    <div class="col-sm-6">
                                        <form action="journal_lost_entry.jsp" method="post">
                            ...
                            String sql = "select * from journal where j_acc_no = '"+request.getParameter("txt_sid")+"' "; 
                            ResultSet rs = st.executeQuery(sql);
                            while(rs.next())
                            {
                                acc_no=rs.getString("j_acc_no");
                                title=rs.getString("j_title");
                                dept=rs.getString("j_department");
                                category=rs.getString("j_category");
                            }
                            }
                            catch(Exception ex)
                            {
                ...
                <form name="journal_lost_entry" action="lost_entry" method="Post">
   
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                
                <!--First and Second Row-->
                <div class="row">
                    <div class="col-sm-4"><label class="x" for="journal-title">Accessing No.</label></div>                  
                    <div class="col-sm-4"><label class="x" for="journal-title">Journal Title</label></div>
                    <div class="col-sm-4"><label class="x" for="author">Department</label></div>                   
                </div>
                <div class="row">
                    <!--Hidden field for status-->
                    <input type="hidden" name="status" value="lost">
                    <div class="col-sm-4"><input class="y" type="text" value="<%=acc_no%>" id="accessing-no" name="accessing_no" required></div>                 
                    <div class="col-sm-4"><input class="y" type="text" value="<%=title%>" id="journal-title" name="journal_title" required></div>
                    <div class="col-sm-4"><input class="y" type="text" value="<%=dept%>" id="journal-title" name="department" required></div>
                </div><br><br>
                ...
                <div class="row">
                   ...
                   <div class="col-sm-4"><label class="x" for="issue-date">Lost/Disposal</label></div>                 
                </div>                   
                <div class="row">
                    <div class="col-sm-4"><input class="y" type="text" value="<%=category%>" id="category" name="category" required></div>
                ...
                <div class="row">
                   <div class="col-sm-3"><input class="y" type="text" id="lost" name="reason" required></div>                  
                   <input type="submit" value="Submit Journal" name="submit" class="addbook" style="margin-bottom: 3%;width: 150px;">
                   <input type="submit" value="Update Journal" name="submit" class="addbook" style="margin-bottom: 3%;width: 150px;">
                   <input type="reset" value="Reset" class="addbook" style="margin-bottom: 3%;width: 150px;">
                    <!--Seven and Eight Row-->                              
            ...
            <!--Searching Method-->
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%">
                <h4 style="margin: 0% 0% 0% 2%">Lost/Disposal Journal List</h4>
                <br><br>
                <div class="row">
                      <input id="search" type="text" placeholder="Search Lost Journal..." style="margin-left: 2.5%;">
                </div>
                <br>
                <table class="tableclass">                                            
                            <thead>
                              <tr>
                                ...
                                <th class="textcenter">Journal Title</th>
