...
<html>
    <head>
        ...
        <title>YCM Secretary - Student Issue Book </title> 
        ...
        <div class="container">
            <div class="content">                   
                        ...
                        <div class="card">
                            <div class="box">  
                                <br>
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Student Issue Book</h4>
                                    </div>                                                                        
                                 </div>
                                <form name="library_assistant_student_issue" action="../assistant_student_issue" method="post">
                ...
                <div class="row">
                   ...
                   <div class="col-sm-4"><label for="issue-date" class="x">Issue Date</label></div>
                   <div class="col-sm-4"><label for="return-date" class="x">Expected Return Date</label></div>                   
                </div>
                <div class="row">
                    <div class="col-sm-4"><input class="y" type="text1" id="accessing-no" name="book_accessing_no" required onclick="fun1();"></div>                 
                ...
                <div class="row">
                    <div class="col-sm-4"><input class="y" type="text1" id="borrower-name" onkeypress="return isNumber(event)" name="student_id" required onclick="fun2();"></div>
                   <input type="hidden" value="issue" name="b_status">
                </div>
            ...
            <!--Searching Method-->
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%">
                <h4 style="margin: 0% 0% 0% 2%">Student Issue Book List</h4>
                <br>
                <div class="row">
