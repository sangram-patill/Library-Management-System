<%-- 
    Document   : principal_journal_stock
    Created on : 30 Apr, 2023, 12:22:29 PM
    Author     : Aditya
--%>
...
<html>
   <head>
        ...
        <title>YCM Principal- Journal Inventory</title> 
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">                                
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Journal Inventory</h4>
                                    </div>
                                </div>
