<%-- 
    Document   : principal_newspaper_stock
    Created on : 30 Apr, 2023, 12:23:24 PM
    Author     : Aditya
--%>
...
<html>
   <head>
        ...
        <title>YCM Principal - Newspapers</title> 
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">                                
                               ...
                               <div class="row">
                                    <input id="search" type="text" placeholder="Search Newspaper..." style="margin-left: 2.5%;">
                               </div>
                                <br>
