<%-- 
    Document   : principal_magazine_stock
    Created on : 30 Apr, 2023, 12:22:53 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Principal - Magazine Inventory</title> 
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">                                
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Magazine Inventory</h4>
                                    </div>
                                 </div>
                                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%">
                               
                                <div class="row">
                                    <input id="search" type="text" placeholder="Search Magazine..." style="margin-left: 2.5%;">
                               </div>
                                <br>
