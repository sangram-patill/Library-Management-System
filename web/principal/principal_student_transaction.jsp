<%-- 
    Document   : principal_student_transaction
    Created on : 16 May, 2023, 12:02:00 PM
    Author     : sangr
--%>
...
<html>
    <head>
        ...
        <title>YCM Principal - Student Transaction</title> 
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Student Transaction</h4>
                                    </div>
                                </div>
