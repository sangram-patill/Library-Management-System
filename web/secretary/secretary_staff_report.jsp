<%-- 
    Document   : staff_report
    Created on : 16 May, 2023, 1:11:43 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Staff Report </title> 
       ...
       <style><%@include file="secretary_dashboard.jsp"%></style> 
        ...
        <div class="container">
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="secretary_staff_report" action="../view_report.jsp" method="post">
                            <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Staff Reports</h4>
                                    </div>       
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Staff">
                                    </div>
                                 </div>     
                 <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Staff Reg No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="staff_id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Staff"></div>
                  ...
                  <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To ID No.</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="staff_acc_1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="staff_acc_2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Staff By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To Date</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="staff_date1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="staff_date2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Staff By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Staff</h4><br>
		...
		<tbody>
            ...
            try {
                 ...
                 String sql = "select * from staff"; ResultSet rs = st.executeQuery(sql);
                ...
                while (rs.next()) 
                {
                    %>
                        <tr>
                            ...
                            <td><img class="image1" src="image/Staff/<%=rs.getString("staff_photo")%>" ></td>
                            <td><img class="image1" src="image/Staff/<%=rs.getString("sign")%>"></td>
                        </tr>
                    <%
                }
            } 
