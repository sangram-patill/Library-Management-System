<%-- 
    Document   : journal_report
    Created on : 16 May, 2023, 1:02:32 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Journal Report </title> 
         ...
         <!---Start Editing from Below Code--->
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="secretary_journal_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Journal Reports</h4>
                                    </div>             
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Journal">
                                    </div>
                                 </div>
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Accessing No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="j_id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Journal"></div>
                  ...
                  <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To ID No.</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="j_acc1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="j_acc2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View Journal By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                       ...
                       <div class="col-sm-4"><label for="issue-date" class="x">To Date</label></div>
                             ...
                             <br>    
                <div class="row">
                   <div class="col-sm-4"><input type="text" name="j_date1" class="y"></div>
                   <div class="col-sm-4"><input type="text" name="j_date2" class="y"></div>
                   <input class="in" type="submit" name="submit" value="View journal By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Journal</h4><br>
