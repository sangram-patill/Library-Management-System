<%-- 
    Document   : student_return_report
    Created on : 16 May, 2023, 4:13:02 PM
    Author     : Aditya
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Student Return Report </title> 
        ...
        <div class="container">
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="secretary_student_return_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Student Return Reports</h4>
                                    </div>              
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Student Return">
                                    </div>
                                 </div>
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Student Return No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Student Return"></div>
                ...
                <div class="row">
                   ...
                   <input class="in" type="submit" name="submit" value="View Student Return By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                   ...
                   <input class="in" type="submit" name="submit" value="View Student Return By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Student Return</h4><br>
