...
<html>
    <head>
        ...
        <title>YCM Secretary - Student Fine Master</title> 
    ...
    <body>      
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Student Fine Master</h4>
                                    </div>
                                </div>
        ...
        <% 
            try {
                 ...
                 String sql = "select * from student_fine"; ResultSet rs = st.executeQuery(sql);
