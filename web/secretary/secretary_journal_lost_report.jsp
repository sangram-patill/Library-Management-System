...
<html>
    <head>
        ...
        <title>YCM Secretary - Journal Lost/Disposal Report </title> 
        ...
        <div class="container">
            <div class="content">                   
                <div class="cards">
                    <div class="card">
                        <br>
                        <form name="secretary_journal_lost_report" action="../view_report.jsp" method="post">
                            
                                 <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Lost/disposal Journal Reports</h4>
                                    </div>             
                                     <div class="col-sm-6">
                                         <input class="stock" type="submit" name="submit" value="Total Lost/Disposal Journals">
                                    </div>
                                 </div>
                ...
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%;">
                            ...
                            <div class="row">
                                    <div class="col-sm-4"><label for="issue-date" class="x">Enter Lost/Disposal Journal No.</label></div>
                            </div><br>                
                    <div class="row">
                        <div class="col-sm-4"><input id="search" type="text" name="id" class="y"></div>
                       <div class="col-sm-4"><input class="in" type="submit" name="submit" value="View Lost/Disposal Journal"></div>
                ...
                <div class="row">
                   ...
                   <input class="in" type="submit" name="submit" value="View Lost/Disposal Journal By ID">
                </div><br>
                  <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                ...
                <div class="row">
                   ...
                   <input class="in" style="margin-left:30px" type="submit" name="submit" value="View Lost/Disposal Journal By Date">
                </div><br>
                 <hr style="background-color: grey;width: 1120px;height:1px;border-width:0;margin-left: 1%;">
                        
                 <h4 style="margin: 0% 0% 0% 2%">All Lost/Disposal Journal</h4><br>
