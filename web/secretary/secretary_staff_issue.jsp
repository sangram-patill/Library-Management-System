<%-- 
    Document   : secretary_staff_issue
    Created on : 16 May, 2023, 3:25:33 PM
    Author     : sangr
--%>
...
<html>
    <head>
        ...
        <title>YCM Secretary - Staff Issue Transaction</title> 
                  ...
                  <div class="cards">
                        <div class="card">
                            <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                         <h4 style="margin: 0% 0% 0% 2%">Staff Issue Transaction</h4>
                                    </div>
                                </div>
