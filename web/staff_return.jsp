...
<html>
    <head>
        ...
        <title>YCM Admin - Staff Return Book </title> 
       ...
       <%
        ...
        <div class="container">
            <div class="content">                   
                                ...
                                <br>
                                 <div class="row">
                                    <div class="col-sm-6">
                                     ...
                                     <div class="col-sm-6">
                                        <form action="staff_return.jsp" method="post">
                ...
                <form name="staff_return" action="staff_return" method="post">
...
<!--                    <video id="preview1"></video><br>-->
            ...
            <!--Searching Method-->
                <hr style="background-color: grey;width: 1120px;height:2px;border-width:0;margin-left: 1%">
                <h4 style="margin: 0% 0% 0% 2%">Staff Return Book List</h4><br>
                <div class="row">
