 ...
 * sangr
 */
public class staff_return extends HttpServlet {
        ...
        if(event.equals("Return Book"))
        {
                try
                {
                   ...
                   { 
                        ...
                        out.println("<script type=\"text/javascript\"> alert('Use Another Tranaction ID..!'); location='staff_return.jsp'; </script>");
                   }
                    else
                    {   
                        ...
                        resp.setContentType("text/html");
                        out.println("<script type=\"text/javascript\">  alert('Book Returned Successfully..!'); location='staff_return.jsp'; </script>");
                    }
                }
                catch(Exception ex)
                {
