 ...
 * sangr
 */
public class assistant_staff_issue extends HttpServlet {
            ...
            try
                {
                    ...
                    { 
                        ...
                        out.println("<script type=\"text/javascript\">  alert('Book Issued Successfully'); location='library_assistant/library_assistant_staff_issue.jsp'; </script>");

                    }
                    else
                    {
                        resp.setContentType("text/html");
                        out.println("<script type=\"text/javascript\"> alert('Invalid Staff ID..!'); location='library_assistant/library_assistant_staff_issue.jsp'; </script>");
                    }
                }
                catch(Exception ex)
                {
