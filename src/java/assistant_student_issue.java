 ...
 * sangr
 */
public class assistant_student_issue extends HttpServlet {
...
//                    String sql3 = "select * from add_book where b_acc_no = '"+book_accessing_no+"'"; ResultSet rs1 = st.executeQuery(sql3);
                    ...
                    { 
                        ...
                        out.println("<script type=\"text/javascript\">  alert('Book Isuued Successfully'); location='library_assistant/library_assistant_student_issue.jsp'; </script>");
...
//                        }
                        resp.setContentType("text/html");
                        out.println("<script type=\"text/javascript\"> alert('Invalid Student ID..!'); location='library_assistant/library_assistant_student_issue.jsp'; </script>");
                    }
                }
                catch(Exception ex)
                {
